...
1. **Read `/home/adam/Dev/blog/needmorecowbell.github.io/Auto Run Docs/LOOP_00001_CANDIDATES.md`** to get the list of candidates
2. **Read `/home/adam/Dev/blog/needmorecowbell.github.io/Auto Run Docs/LOOP_00001_PLAN.md`** (if it exists) to see which candidates have already been evaluated
...
6. **Append to `/home/adam/Dev/blog/needmorecowbell.github.io/Auto Run Docs/LOOP_00001_PLAN.md`**
...
Append to `/home/adam/Dev/blog/needmorecowbell.github.io/Auto Run Docs/LOOP_00001_PLAN.md` using this structure (create file with header if it doesn't exist):
...
1. You've evaluated exactly ONE candidate from `/home/adam/Dev/blog/needmorecowbell.github.io/Auto Run Docs/LOOP_00001_CANDIDATES.md`
2. You've appended a complete evaluation to `/home/adam/Dev/blog/needmorecowbell.github.io/Auto Run Docs/LOOP_00001_PLAN.md`
