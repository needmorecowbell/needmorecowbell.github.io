...
2. **Identify refactoring-sensitive areas** based on:
   ...
   - Dead or unused code
3. **Output a tactical game plan** to `/home/adam/Dev/blog/needmorecowbell.github.io/Auto Run Docs/LOOP_00001_GAME_PLAN.md`
...
Create/update `/home/adam/Dev/blog/needmorecowbell.github.io/Auto Run Docs/LOOP_00001_GAME_PLAN.md` with the following structure:
